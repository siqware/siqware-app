    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-user-material">
            <div class="sidebar-user-material-body">
                <div class="card-body text-center">
                    <a href="#">
                        <img src="{{asset('dashboard/material/main_assets/images/image.png')}}" class="img-fluid rounded-circle shadow-1 mb-3" width="80" height="80" alt="">
                    </a>
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item">
                    <a href="{{route('media')}}" class="nav-link {{request()->is('media')? 'active':null}}">
                ...
                <li class="nav-item">
                    <a href="changelog.html" class="nav-link">
                        ...
                        <span class="badge bg-pink-300 align-self-center ml-auto">5</span>
                    </a>
                </li>
                <!-- /main -->
